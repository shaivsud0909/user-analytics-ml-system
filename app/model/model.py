...
from app.config import CSV_FILE_PATH,RETRAINING_DATA_PATH
...
def model_training():
    try: 
        ...
        df2= pd.read_csv(RETRAINING_DATA_PATH)

        #combine the original data with the new data from feedback
